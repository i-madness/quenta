...
const maleNameParts = ['дил', 'шим', 'кай', 'мэй', 'эль', 'ол', 'хим', 'рой', "ронд", "он", "сим", "гранж", 'филд', 'талас', 'стер', 'зул', 'кард', 'кил', "дес", "ранг", "огил", "зис", "тан", "тео", "лес", "ст", 'вит', 'пе', "теск", "ольм", "тен", "мон"]
...
const otherNameParts = [ "кет", "зе", "мезе", "ше", "пе", "льпе", "фес", "сис", "'фе", "мо", "умо", "уно", "пург", "тарпо", "ольмо", "зефф", "черс", "тур", "'омо", "рене", "рено", "шефе", "оссе", "'харж", "бре" ]
