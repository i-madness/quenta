...
const femaleNameParts = ["дина", "шима", "кая", 'мэй', 'эль', "кина", "энь", "уфа", "уха", "тесс", "эсс", 'ола', 'ра', "вен", 'ада', 'бра', 'иль', "да", 'лия', 'ья', 'ия', 'теса', "ла", "мара", "на", "минель", "леса", "иса", "тея", "тер", "тра", "нья", 'ктея', "сея", "айя"]
