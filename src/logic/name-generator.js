 ...
 */
const firstParts = ["алас", "тэр", "мон", "фрел", "цум", "рон", "эл", "рол", "кай", "дем", "тор", "кил", "гэл", 'леп', "лагр", "фес", "фел", "анг", "ранд", "так", "рем", "карс", "джакс", "али", "куман", "лора", "ака", "сар", "мира", "нира", "ар", "ки", "о'", "пирс", "кин", "тари", "мек", "ун", "пара", "лито"]

const maleNameParts = ['дил', 'шим', 'кай', 'мэй', 'эль', 'ол', 'хим', 'рой', "ронд", "он", "сим", "гранж", 'филд', 'талас', 'стер', 'зул', 'кард', 'кил', "дес", "ранг", "огил", "зис", "тан", "тео", "лес", "ст", 'вит', 'пе', "теск", "ольм", "тен", "мон", "зен", "ис", "ус", "нус", "нис", "гус", "нус", "анс"]
...
const otherNameParts = [ "кет", "зе", "мезе", "ше", "пе", "льпе", "фес", "сис", "'фе", "мо", "умо", "уно", "пург", "тарпо", "ольмо", "зефф", "черс", "тур", "'омо", "рене", "рено", "шефе", "оссе", "'харж", "бре", "те", "ги", "иги"]
