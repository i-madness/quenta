...
const maleNameParts = {
  ...
  2: ['дил', 'шим', 'кай', 'мэй', 'эль', 'ол', 'хим', 'рой', "ронд", "он", "сим", "гранж", 'филд', 'талас', 'стер', 'зул', 'кард', 'кил', "ранг", "огил", "зис", "тан", "тео", "лес", "ст", 'вит', 'пе']
}

const femaleNameParts = {
  1: ['лора', 'тэр', 'мон', 'фрел', 'цум', 'рон', 'эл', 'ака', "сар", "мира", "нира", "ки", "о'", "пирс", "рем", "кин", "тари", "мек", "ун", "пара", "лито", "так"],
  2: ['дина', 'шима', 'кая', 'мэй', 'эль', "кина", "энь", "уфа", "уха", "тесс", "эсс", 'ола', 'ра', 'ада', 'иль', "да", 'лия', 'ья', 'ия', 'теса', "ла", "мара", "на", "минель", "леса", "иса", "тея", "тер", "тра"]
}
