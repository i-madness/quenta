...
const maleNameParts = {
  1: ['алас', 'тэр', 'мон', 'фрел', 'цум', 'рон', 'эл', "рол", "кай", "эл", "дем", "тор", "кил", "гэл", "лагр", 'фел', 'анг', "ранд", "рем", "карс"],
  2: ['дил', 'шим', 'кай', 'мэй', 'эль', 'ол', 'хим', 'рой', "ронд", "он", "сим", "гранж", 'филд', 'талас', 'стер', 'зул', 'кард', 'кил', "ранг", "огил", "зис", "тео", "лес", "ст", 'вит']
}

const femaleNameParts = {
  1: ['лора', 'тэр', 'мон', 'фрел', 'цум', 'рон', 'эл', 'ака', "сар", "мира", "нира", "ки", "о'", "пирс", "рем"],
  2: ['дина', 'шима', 'кая', 'мэй', 'эль', 'ола', 'ра', 'ада', 'иль', "да", 'лия', 'ья', 'ия', 'теса', "ла", "мара", "на", "минель", "леса", "иса", "тея", "тер"]
}
